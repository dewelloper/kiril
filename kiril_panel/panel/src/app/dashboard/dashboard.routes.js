...
var server_detail_component_1 = require("./server/servers/server-detail.component");
...
exports.MODULE_ROUTES = [
    ...
    { path: 'server/detail/:id', component: server_detail_component_1.ServerDetailComponent },
