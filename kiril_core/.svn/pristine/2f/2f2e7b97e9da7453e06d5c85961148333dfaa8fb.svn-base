...
namespace Markum.Cloud.Libraries.AddressMap {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://mailenable.com/MEWebAdminService/AddressMap", ConfigurationName="AddressMap.AddressMapSoap")]
    public interface AddressMapSoap {
        ...
        Markum.Cloud.Libraries.AddressMap.ListAddressMapResponse ListAddressMap(Markum.Cloud.Libraries.AddressMap.ListAddressMapRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://mailenable.com/MEWebAdminService/AddressMap/ListAddressMap", ReplyAction="*")]
        System.Threading.Tasks.Task<Markum.Cloud.Libraries.AddressMap.ListAddressMapResponse> ListAddressMapAsync(Markum.Cloud.Libraries.AddressMap.ListAddressMapRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(MarshalByRefObject))]
        Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesResponse GetAddressMapObjectProperties(Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://mailenable.com/MEWebAdminService/AddressMap/GetAddressMapObjectProperties", ReplyAction="*")]
        System.Threading.Tasks.Task<Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesResponse> GetAddressMapObjectPropertiesAsync(Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesRequest request);
    ...
    public partial class ListAddressMapRequest {
        ...
        public Markum.Cloud.Libraries.AddressMap.AddressMap[] ObjectList;
        ...
        public ListAddressMapRequest(Markum.Cloud.Libraries.AddressMap.AddressMap[] ObjectList, string AccountName, string SourceAddress, string DestinationAddress, string Scope, long Status, long Top, long MaxLength) {
    ...
    public partial class ListAddressMapResponse {
        ...
        public ListAddressMapResponse(long ListAddressMapResult, Markum.Cloud.Libraries.AddressMap.AddressMap[] ObjectList) {
    ...
    public partial class GetAddressMapObjectPropertiesRequest {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://mailenable.com/MEWebAdminService/AddressMap", Order=5)]
        public Markum.Cloud.Libraries.AddressMap.AddressMap ObjectProperties;
        
        public GetAddressMapObjectPropertiesRequest() {
        }
        
        public GetAddressMapObjectPropertiesRequest(string AccountName, string SourceAddress, string DestinationAddress, string Scope, long Status, Markum.Cloud.Libraries.AddressMap.AddressMap ObjectProperties) {
            this.AccountName = AccountName;
            this.SourceAddress = SourceAddress;
            this.DestinationAddress = DestinationAddress;
            this.Scope = Scope;
    ...
    public partial class GetAddressMapObjectPropertiesResponse {
        ...
        public GetAddressMapObjectPropertiesResponse(long GetAddressMapObjectPropertiesResult, Markum.Cloud.Libraries.AddressMap.AddressMap ObjectProperties) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AddressMapSoapChannel : Markum.Cloud.Libraries.AddressMap.AddressMapSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AddressMapSoapClient : System.ServiceModel.ClientBase<Markum.Cloud.Libraries.AddressMap.AddressMapSoap>, Markum.Cloud.Libraries.AddressMap.AddressMapSoap {
        ...
        Markum.Cloud.Libraries.AddressMap.ListAddressMapResponse Markum.Cloud.Libraries.AddressMap.AddressMapSoap.ListAddressMap(Markum.Cloud.Libraries.AddressMap.ListAddressMapRequest request) {
            return base.Channel.ListAddressMap(request);
        }
        
        public long ListAddressMap(ref Markum.Cloud.Libraries.AddressMap.AddressMap[] ObjectList, string AccountName, string SourceAddress, string DestinationAddress, string Scope, long Status, long Top, long MaxLength) {
            Markum.Cloud.Libraries.AddressMap.ListAddressMapRequest inValue = new Markum.Cloud.Libraries.AddressMap.ListAddressMapRequest();
            ...
            Markum.Cloud.Libraries.AddressMap.ListAddressMapResponse retVal = ((Markum.Cloud.Libraries.AddressMap.AddressMapSoap)(this)).ListAddressMap(inValue);
            ObjectList = retVal.ObjectList;
            return retVal.ListAddressMapResult;
        }
        
        public System.Threading.Tasks.Task<Markum.Cloud.Libraries.AddressMap.ListAddressMapResponse> ListAddressMapAsync(Markum.Cloud.Libraries.AddressMap.ListAddressMapRequest request) {
            return base.Channel.ListAddressMapAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesResponse Markum.Cloud.Libraries.AddressMap.AddressMapSoap.GetAddressMapObjectProperties(Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesRequest request) {
            return base.Channel.GetAddressMapObjectProperties(request);
        }
        
        public long GetAddressMapObjectProperties(string AccountName, string SourceAddress, string DestinationAddress, string Scope, long Status, ref Markum.Cloud.Libraries.AddressMap.AddressMap ObjectProperties) {
            Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesRequest inValue = new Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesRequest();
            inValue.AccountName = AccountName;
            inValue.SourceAddress = SourceAddress;
            inValue.DestinationAddress = DestinationAddress;
            inValue.Scope = Scope;
            ...
            Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesResponse retVal = ((Markum.Cloud.Libraries.AddressMap.AddressMapSoap)(this)).GetAddressMapObjectProperties(inValue);
            ObjectProperties = retVal.ObjectProperties;
            return retVal.GetAddressMapObjectPropertiesResult;
        }
        
        public System.Threading.Tasks.Task<Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesResponse> GetAddressMapObjectPropertiesAsync(Markum.Cloud.Libraries.AddressMap.GetAddressMapObjectPropertiesRequest request) {
